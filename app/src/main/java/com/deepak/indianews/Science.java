...
public class Science extends Fragment {
    ...
    RecyclerView science_recycler_view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        science_recycler_view = view.findViewById(R.id.science_recycler_view);
        science_recycler_view.setLayoutManager(new LinearLayoutManager(view.getContext()));
        NewsDetails newsDetails = RetrofitInformation.getRetrofit().create(NewsDetails.class);
        Call<BusinessNews> businessNewsCall = newsDetails.getBusiness("in", "science", API_KEY);
        businessNewsCall.enqueue(new Callback<BusinessNews>() {
            ...
            public void onResponse(Call<BusinessNews> call, Response<BusinessNews> response) {
                ...
                science_recycler_view.setAdapter(adapter);
