...
public class Entertainment extends Fragment {
    ...
    RecyclerView entertainment_recycler_view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        entertainment_recycler_view = view.findViewById(R.id.entertainment_recycler_view);
        entertainment_recycler_view.setLayoutManager(new LinearLayoutManager(view.getContext()));
        NewsDetails newsDetails = RetrofitInformation.getRetrofit().create(NewsDetails.class);
        Call<BusinessNews> businessNewsCall = newsDetails.getBusiness("in", "entertainment", API_KEY);
        businessNewsCall.enqueue(new Callback<BusinessNews>() {
            ...
            public void onResponse(Call<BusinessNews> call, Response<BusinessNews> response) {
                ...
                entertainment_recycler_view.setAdapter(adapter);
