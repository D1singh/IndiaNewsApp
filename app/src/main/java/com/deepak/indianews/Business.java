...
public class Business extends Fragment {
    ...
    RecyclerView business_recycler_view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        business_recycler_view = view.findViewById(R.id.business_recycler_view);
        business_recycler_view.setLayoutManager(new LinearLayoutManager(view.getContext()));
        NewsDetails newsDetails = RetrofitInformation.getRetrofit().create(NewsDetails.class);
          Call<BusinessNews> businessNewsCall = newsDetails.getBusiness("in","business",API_KEY);
       businessNewsCall.enqueue(new Callback<BusinessNews>() {
           ...
           public void onResponse(Call<BusinessNews> call, Response<BusinessNews> response) {
              ...
              business_recycler_view.setAdapter(adapter);
